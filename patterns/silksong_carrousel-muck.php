...
<div class="wp-block-cover alignfull" style="border-width:2px;margin-top:0;margin-bottom:0;padding-top:4vw;padding-right:4vw;padding-bottom:4vw;padding-left:4vw;min-height:777px"><img class="wp-block-cover__image-background wp-image-86 size-full" alt="" src="https://mmi.unilim.fr/~villoutreix8/wordpress/wp-content/uploads/2026/03/Silksong-Bilewater-Header.webp" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"textColor":"white","fontSize":"silksong_big-title"} -->
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color has-silksong-big-title-font-size">Going somewhere muddy?</h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"right","fontSize":"silksong_title"} -->
<h2 class="wp-block-heading has-text-align-right has-silksong-title-font-size">Wreath of purity</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"right","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-blue"}}},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"0","right":"0"}}},"textColor":"custom-blue","fontSize":"silksong_medium","fontFamily":"poppins"} -->
...
<div class="wp-block-buttons" style="border-style:none;border-width:0px;border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px"><!-- wp:button {"width":100,"className":"is-style-button-grad","fontSize":"silksong_title"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-button-grad"><a class="wp-block-button__link has-silksong-title-font-size has-custom-font-size wp-element-button" href="https://mmi.unilim.fr/~villoutreix8/wordpress/product/wreath-of-purity/">Get it now !</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
